    ...
    .controller('uiCalendarCtrl', ['$scope', '$locale',
        function ($scope, $locale) {
            ...
            this.eventFingerprint = function (e) {
                ...
                return [e.id || '', e.title || '', e.url || '', start, end, e.allDay || '', e.className || '', extraSignature].join('');
            };
        ...
        function (uiCalendarConfig) {
            ...
            return {
                ...
                link : function (scope, elm, attrs, controller) {
                    ...
                    scope.getEvent= function(hashKey){
                    	var clientEvents = calendar.fullCalendar('clientEvents');
                        for (var i = 0; i < clientEvents.length; i++) {
                        	var clientEvent = clientEvents[i];
                        	if(clientEvent.$$hashKey == hashKey){
                        		return clientEvent;
                        	}
                        }
                    }
                    ...
                    eventsWatcher.onRemoved = function (event) {
                        if (calendar && calendar.fullCalendar) {
                            ...
                            /*calendar.fullCalendar('removeEvents', function(ev){
                            	return ev.$$hashKey == event.$$hashKey
                            });*/
                        }
                    };
                    ...
                    /*eventsWatcher.onChanged = function (event) {
                        if (calendar && calendar.fullCalendar) {
                            ...
                            for (var i = 0; i < clientEvents.length; i++) {
                            	var clientEvent = clientEvents[i];
                            	if(clientEvent.$$hashKey == event.$$hashKey){
