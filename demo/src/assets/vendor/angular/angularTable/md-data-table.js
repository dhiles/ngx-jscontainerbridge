...
function mdColumn($compile, $mdUtil) {
  ...
  function postLink(scope, element, attrs, ctrls) {
    ...
    function attachSortIcon() {
      var sortIcon = angular.element('<md-icon md-svg-icon="vendor/angular/angularTable/arrow-up.svg">');
  ...
  function postLink(scope, element, attrs, ctrls) {
    ...
    self.isSelected = function () {
        ...
        if(tableCtrl.enableMultiSelect()){
          for(var itr=0;itr<tableCtrl.selected.length;itr++){
            if(angular.equals(self.model,tableCtrl.selected[itr])){
                return true;  
            }
          }
        }
    ...
    self.deselect = function () {
      ...
      if(tableCtrl.enableMultiSelect()){
        for(var itr=0;itr<tableCtrl.selected.length;itr++){
          if(angular.equals(self.model,tableCtrl.selected[itr])){
            tableCtrl.selected.splice(itr, 1);
            break;  
          }
        }
      }else{
...
function mdTablePagination() {
  ...
  return {
    ...
    restrict: 'E',
    scope: {},
    templateUrl: 'vendor/angular/angularTable/md-table-pagination.html'
  };
}
...
function mdTableProgress() {
  ...
  return {
    ...
    restrict: 'A',
    scope: {},
    templateUrl: 'vendor/angular/angularTable/md-table-progress.html'
  };
}
