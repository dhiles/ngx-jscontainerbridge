...
module.provider('Restangular', function() {
        ...
        Configurer.init = function(object, config) {
            ...
            var safeMethods= ["get", "head", "rest_options", "trace", "getlist"];
            ...
            **/
            ...
            BaseCreator.prototype.resource = function(current, $http, localHttpConfig, callHeaders, callParams, what, etag, operation) {
                ...
                return RestangularResource(this.config, $http, url, {
                    ...
                    rest_options: this.config.withHttpValues(localHttpConfig,
                      {method: 'OPTIONS',
                      params: params,
                      headers: headers}),
       ...
       this.$get = ['$http', '$q', function($http, $q) {
          ...
          function createServiceForConfiguration(config) {
              ...
              function restangularizeElem(parent, element, route, fromServer, collection, reqParams) {
                  ...
                  localElem[config.restangularFields.rest_options] = _.bind(optionsFunction, localElem);
             ...
             function optionsFunction(params, headers) {
               return _.bind(elemFunction, this)("rest_options", undefined, params, undefined, headers);
             }
